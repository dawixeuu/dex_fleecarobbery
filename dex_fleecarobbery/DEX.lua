DEX = {}
DEX.timer = 300 -- countdown to secure lock in seconds (time needed to pass to door to be closed back)
DEX.hacktime = 1000 -- first door open delay to make time for police to arrive and roleplay in miliseconds (I highly recommend to leave it be (2.5 min default))
DEX.maxcash = 6500 -- maximum amount of cash a pile can hold
DEX.mincash = 3000 -- minimum amount of cash a pile holds
DEX.black = false -- enable this if you want blackmoney as a reward
DEX.cooldown = 600 -- amount of time to do the heist again in seconds (15min)
DEX.mincops = 4 -- minimum required cops to start mission
DEX.vaultdoor = "v_ilev_cbankvauldoor01"
DEX.door = "v_ilev_cbankvaulgate01"
DEX.office = "v_ilev_gb_teldr"
DEX.Banks = {
    F0 = { -- paleto bank
        doors = {    
